...
// ---------------------------------------------------------------------------
// Embedded "ticker" user program (second ELF sample)
//
// A simple loop that:
// 1. Calls SYS_TICKS to get current tick count
// 2. Sends it as a message via SYS_SEND_MSG
// 3. Yields with SYS_YIELD
// 4. Repeats 5 times
// 5. Exits
// ---------------------------------------------------------------------------
#[rustfmt::skip]
pub static TICKER_ELF: &[u8] = &[
    ...
    0x48, 0xC7, 0xC0, 0x04, 0x00, 0x00, 0x00,     // mov rax, 4 (SYS_TICKS)
    0x0F, 0x05,                                    // syscall
    0x48, 0x89, 0xC6,                              // mov rsi, rax
    0x48, 0xC7, 0xC7, 0x00, 0x10, 0x40, 0x00,     // mov rdi, 0x401000
    0x89, 0x37,                                    // mov dword [rdi], esi
    0x48, 0xC7, 0xC0, 0x16, 0x00, 0x00, 0x00,     // mov rax, 22 (SYS_SEND_MSG)
    0x48, 0xC7, 0xC6, 0x08, 0x00, 0x00, 0x00,     // mov rsi, 8
    0x0F, 0x05,                                    // syscall
    0x48, 0xC7, 0xC0, 0x14, 0x00, 0x00, 0x00,     // mov rax, 20 (SYS_YIELD)
    0x0F, 0x05,                                    // syscall
    0x48, 0xFF, 0xC9,                              // dec rcx
    0x75, 0xD8,                                    // jnz (loop back)
    0x48, 0xC7, 0xC0, 0x15, 0x00, 0x00, 0x00,     // mov rax, 21 (SYS_EXIT)
