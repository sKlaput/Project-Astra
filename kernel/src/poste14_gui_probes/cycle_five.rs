...
pub(super) fn probe_poste14_gui_recovery_guardrails_continuity_hysteresis_v3_baseline_extended5() {
    ...
    let window_ok =
        recover_guard_cont_hyst3_ext5_ready && recovery_guardrails_cont_hyst3_ext5_surface_ready;
    ...
    serial::write_str(
        "gui-recover-guard-cont-hyst3-ext5: window recover_guard_cont_hyst3_ext5_ready=",
    );
...
pub(super) fn probe_poste14_gui_guardrails_continuity_hysteresis_envelope_v3_baseline_extended5() {
    ...
    let window_ok = guard_cont_hyst_envelope3_ext5_ready
        && guardrails_continuity_hyst_envelope3_ext5_surface_ready;
    let policy_ok = window_ok && process_ok && syscall_ok;
    ...
    serial::write_str(
        "gui-guard-cont-hyst-envelope3-ext5: window guard_cont_hyst_envelope3_ext5_ready=",
    );
