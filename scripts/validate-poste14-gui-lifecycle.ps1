param(
    ...
    [string]$OutPrefix = "build/poste14-gui-lifecycle-validate"
)
...
$failHits = @(
    Select-String -Path $logPath -Pattern "gui-life: .*FAIL|page fault|panic" -CaseSensitive:$false |
...
$lines = @(
    "Post-E14 GUI Lifecycle Validation: $result",
...
Write-Host "[poste14-gui-life] summary -> $summaryPath"
Write-Host "[poste14-gui-life] json -> $jsonPath"
