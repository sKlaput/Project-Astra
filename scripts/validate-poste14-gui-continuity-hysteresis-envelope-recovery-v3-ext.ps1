#!/usr/bin/env pwsh
# Focused validator for Post-E14 Slice 76: GUI continuity hysteresis envelope recovery v3 extended baseline

param(
    [string]$OutPrefix = "build/poste14-guiconthystenveloperecover3ext-s76"
)
...
$failPatterns = @(
    "gui-cont-hyst-envelope-recover3-ext: .*FAIL",
    "page fault",
    "panic"
)
...
$summary = @()
$summary += "Post-E14 Slice 76: GUI continuity hysteresis envelope recovery v3 extended baseline"
...
$jsonSummary = @{
    slice = 76
    name = "GUI continuity hysteresis envelope recovery v3 extended baseline"
