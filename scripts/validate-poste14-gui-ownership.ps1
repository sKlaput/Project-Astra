param(
    ...
    [string]$OutPrefix = "build/poste14-gui-ownership-validate"
)
...
$failHits = @(
    Select-String -Path $logPath -Pattern "gui-own: .*FAIL|page fault|panic" -CaseSensitive:$false |
...
$lines = @(
    "Post-E14 GUI Ownership Validation: $result",
...
Write-Host "[poste14-gui] json -> $jsonPath"
